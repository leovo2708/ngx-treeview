...
var core_1 = __webpack_require__("../../../core/@angular/core.es5.js");
var lib_1 = __webpack_require__("../../../../../src/lib/index.ts");
var DropdownTreeviewSelectI18n = (function (_super) {
    __extends(DropdownTreeviewSelectI18n, _super);
    function DropdownTreeviewSelectI18n() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(DropdownTreeviewSelectI18n.prototype, "selectedItem", {
        get: function () {
    ...
    DropdownTreeviewSelectI18n.prototype.getText = function (checkededItems, isAll) {
        return this._selectedItem ? this._selectedItem.text : 'All';
    };
    return DropdownTreeviewSelectI18n;
}(lib_1.TreeviewI18nDefault));
exports.DropdownTreeviewSelectI18n = DropdownTreeviewSelectI18n;
    ...
    ProductComponent.prototype.removeItem = function (item) {
        ...
        for (var i = 0; i < this.items.length; i++) {
            if (this.items[i] === item) {
                ...
                isRemoved = lib_1.TreeviewHelper.removeItem(this.items[i], item);
                if (isRemoved) {
                    break;
                }
            }
